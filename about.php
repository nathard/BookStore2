...
<!-- end of header -->
    ...
    <div id="templatemo_content">
        ...
        <div id="templatemo_content_right">
			...
			<br/><br/>Why choose us?<br/>
			- we can provide a lot of books <br />
			- we can ship fast and low cost<br/>
			- we have a lot of discounts book<br/>
			if you can not find a book on our website, please send us an email to<br/>
			<a href="mailto:books@bookstore.com">books@bookstore.com</a><br/>
            </p>
