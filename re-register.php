...
<!-- end of header -->
    ...
    <div id="templatemo_content">
        ...
        <div id="templatemo_content_right">
            ...
            <h1><img src="images/bullet6.gif" alt="" title=""/>Register</h1>
			        
        	<div class="feat_prod_box_details">
            <p class="details">
			<strong style="color:#FF0000;">I'm sorry but the username you specified has already been taken.  Please pick another one.</strong>
			<br />
